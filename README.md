...
| POST   | api/asks/     | [CreateAskCommand](src/Application/Identity/Requests/UserRegistrationRequest.cs)       | _none_                                                              | Creates a new ask.                                                      | 200                                                        | Signed in users |
...
| GET    | api/adminPanel/supervisors      | _none_                                                                                                         | [GetSupervisorsQuery](src/Application/Models/ApiModels/Supervisors/Queries/GetSupervisorsQuery.cs) | Returns list of supervisors                            | [SupervisorObject](src/Application/Models/DTOs/SupervisorObject.cs)[]                                                                                                      | admin          |
| POST   | api/adminPanel/supervisors      | [UserRegistrationRequest](src/Application/Models/ApiModels/Transactions/Commands/UpdateTransactionCommand.cs)  | _none_                                                                                             | Creates a new supervisor.                              | [AuthFailedResponse](src/Application/Identity/Responses/AuthFailedResponse.cs), [AuthSuccessResponse](src/Application/Identity/Responses/AuthSuccessResponse.cs), 400, 200 | admin          |
| DELETE | api/adminPanel/supervisors/{id} | _none_                                                                                                         | id                                                                                                 | Deletes supervisor if found.                           | 200, 400                                                                                                                                                                   | admin          |
