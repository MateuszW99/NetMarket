...
| POST   | api/identity/register      | [UserLoginRequest](src/Application/Identity/Requests/UserLoginRequest.cs)               | _none_ | Returns JWT token.    | [AuthFailedResponse](src/Application/Identity/Responses/AuthFailedResponse.cs), [AuthSuccessResponse](src/Application/Identity/Responses/AuthSuccessResponse.cs), 400, 200 | everyone       |
