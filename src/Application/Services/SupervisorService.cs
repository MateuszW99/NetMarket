...
namespace Application.Services
{
    public class SupervisorService : ISupervisorService
    {
        ...
        public SupervisorService(IApplicationDbContext context, IUserManagerService userManagerService, IIdentityService identityService)
        {
            _context = context;
        ...
        public async Task<List<SupervisorObject>> GetSupervisorsAsync(string searchQuery)
        {
            ...
            {
                queriedSupervisors = queriedSupervisors.Where(x => x.Email.ToLower().Contains(searchQuery.ToLower()));
            }
